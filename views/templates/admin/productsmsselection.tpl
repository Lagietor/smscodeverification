<div class="panel col-lg-12">
    ...
    <div class="panel-footer">
        <input type="submit" class="btn btn-default pull-right" name="SmsActivationFormSubmit" value="{l s='Save' mod='smscodeverification'}" form="form-smscodeverification_product_list">
    </div>
</div>
